...
Public Class MainForm
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If MsgBox("This program will create an unattend.xml file which you can place in {your_mount_directory}\Windows\Panther either for OEM or Consumer use. Click Yes to start the program. The unattend file you generate with this tool will only work on AMD64/x64 PCs.", MsgBoxStyle.YesNo + MsgBoxStyle.Information, Me.Text) = DialogResult.Yes Then
